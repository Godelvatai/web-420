/*
      Express application for in-n-out-books project
  ...
  <html lang="en">
    <head>
      ...
      <style>
        ...
        h3 { color: #zf; }
        .container { width: 50%; margin: 0 auto; font-family: 'Lora', serif; padding-bottom: 100px; }
    ...
    <body>
      ...
      <footer>
        <p>Hours of Operation: 7:30am - 8:00pm Monday - Friday. 7:00am - 9:00pm Saturday & Sunday.</p>
        <p>Contact Us: inoutbooks@books.com   (465) 456-3253</p>
      </footer>
    </body>
  </html>
